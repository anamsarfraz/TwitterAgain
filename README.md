...
* [x] User can follow additional people from follower/ following view
* [x] In messaging, allow the user to search for people to message
* [x] In messaging, check to see if the user can send a direct message to the recipient otherwise show an error.
* [x] Added navigation drawer
* [x] Added favorites and photos in user profile
* [x] Added trends in search view on first load
* [x] Added retweeted status for a retweeted tweet

## Video Walkthrough

Here's a walkthrough of implemented user stories:

https://drive.google.com/file/d/0B7G3Mp_zMa_4Nzg1QjN0YnJVcGM/view?usp=sharing

<img src='https://drive.google.com/file/d/0B7G3Mp_zMa_4Nzg1QjN0YnJVcGM/view?usp=sharing
