...
public class FavoritesFragment extends TweetsListFragment {
    ...
    public static FavoritesFragment newInstance(String screenName) {
        ...
        FavoritesFragment userFragment = new FavoritesFragment();
    ...
    public void fetchTimeline() {
        ...
        client.getUserFavorites(screenName, currMaxId, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONArray jsonArray) {
                hideRefreshControl();
                Log.d("DEBUG", "favorites: " + jsonArray.toString());
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                hideRefreshControl();
                Log.e(ERROR, "Error fetching favorites list: " + (errorResponse == null ? "Unknown error" : errorResponse.toString()));
